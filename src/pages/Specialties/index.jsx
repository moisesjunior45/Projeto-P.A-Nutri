...
export default function Specialties() {
  return (
    <section
      id="specialties"
      className="bg-primary py-16 min-h-screen bg-cover bg-center bg-no-repeat w-full"
    ...
    >
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center justify-items-center max-w-[1200px] mx-auto px-4">
